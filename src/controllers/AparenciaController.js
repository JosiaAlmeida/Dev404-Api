...
exports.AparenciaController = void 0;
const AparenciaServices_1 = require("../services/AparenciaServices");
const service = new AparenciaServices_1.AparenciaServices();
class AparenciaController {
    ...
    FindBy(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const Types = yield service.FindByAparencia(id);
            return res.status(200).json(Types);
        });
    }
    Update(req, res) {
...
exports.AparenciaController = AparenciaController;
